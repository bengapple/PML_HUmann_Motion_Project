testdata <- read.csv(file = 'D:/RFiles/machine_learning/PML_Human_Motion_Project/pml-testing.csv', na.strings = c('NA','#DIV/0!',''))
traindata <- read.csv(file = 'D:/RFiles/machine_learning/PML_Human_Motion_Project/pml-training.csv', na.strings = c('NA','#DIV/0!',''))
